...
class ShapeTest {
    ...
    public void testTriangleArea2() {
        Shape2D shape = new Triangle(0.5, .25);
        assertEquals(.063, shape.getArea(), .001);
    }
    ...
    public void testCircleArea() {
        ...
        assertEquals(314.16, shape.getArea(), .01);
    }

    @Test
    public void testCircleArea2() {
        Shape2D shape = new Circle(0.5);
        assertEquals(.79, shape.getArea(), .01);
    }
